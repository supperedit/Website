...
function scatterPositions(slugs: string[]): Record<string, StickerPosition> {
  ...
  slugs.forEach((slug, i) => {
    ...
    positions[slug] = {
      ...
      rotation: rotationSeed * 10, // smaller tilt now that these are text tags, not drawings
    };
  });
    ...
    <div className="sk-outer">
      <div className="sk-stack">
        ...
        <div className="sk-card" ref={cardRef}>
          ...
          {/*
            Seasonal ingredients as scattered text tags. Previously these were
            hand-drawn sprite illustrations; now it's just the ingredient name
            in a small rotated label, keeping the same scatter/drag/tap interaction.
          */}
      ...
      <style>{`
        ...
        .sk-sticker {
          ...
          font-size: 12px;
          white-space: nowrap;
          box-shadow: 0 4px 10px rgba(43, 18, 16, 0.12);
          cursor: grab;
          pointer-events: auto;
          touch-action: none;
          user-select: none;
