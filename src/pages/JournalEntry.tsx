...
function StampBadge({ text }: { text: string }) {
  ...
  return (
    <svg
      width="96"import { useParams, useNavigate, Link } from "react-router-dom";
import { ChevronLeft } from "lucide-react";
import { useJournal } from "../data/useJournal";
import { useRecipes } from "../data/useRecipes";
import RecipeCard from "../components/RecipeCard";
...
export default function JournalEntry() {
  ...
  const steckbriefRows: { label: string; value: string; span?: boolean }[] = [
    entry.typ ? { label: "Typ", value: entry.typ } : null,
    entry.category ? { label: "Kategorie", value: entry.category } : null,
    ...
    entry.latinName
      ...
      : null,
    entry.bloomTime ? { label: "Bluetezeit", value: entry.bloomTime } : null,
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .je-steckbrief > .je-field {
          border-bottom: 1px solid var(--color-border,#e0d8cc);
        }
        .je-steckbrief > .je-field:last-child {
          border-bottom: none;
        }

        .je-steckbrief > .je-field-pair {
          display: grid;
          grid-template-columns: 1fr 1fr;
          border-bottom: 1px solid var(--color-border,#e0d8cc);
        }
        .je-steckbrief > .je-field-pair:last-child {
          border-bottom: none;
        }
      ...
      <article>
        ...
        >
          ...
          <div className="je-grid">
            ...
            <div>
              <div className="je-steckbrief" role="list" aria-label="Steckbrief">
